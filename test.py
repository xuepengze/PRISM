...
parser = argparse.ArgumentParser(description='Image Deraining using PMUNet')

parser.add_argument('--input_dir', default='Datasets/test/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='results/', type=str, help='Directory for results')
parser.add_argument('--weights', default=r'checkpoints/Deraining/models/PMUNet/model_best.pth', type=str, help='Path to weights')
