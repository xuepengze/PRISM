...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        #  Added: Gradient cropping configuration
        self._C.OPTIM.USE_GRAD_CLIP = False
        self._C.OPTIM.GRAD_CLIP_NORM = 5
        self._C.OPTIM.LOG_GRADIENT_STATS = False
        self._C.OPTIM.GRADIENT_LOG_INTERVAL = 5
